...
Скрипт заменяет аватарки и имена игроков форумной ролевой игры в нужных ветках форума.

Как это работает
=========
(Примечание автора - или должно работать :)

Производится "косметическая" замена аватарок пользователей на игровые из настроек в начале скрипта.
Страница форумной игры загружается, затем скрипт автоматически срабатывает и заменяет картинки аватарок пользователей на игровые (оригинальные картинки скрываются).
Данный скрипт автоматически сверяет название темы с игрой и название в скрипте, потому можно не волноваться, что скрипт заменит аватарки в других ветках форума.

Возможности:
- автоматическая замена всех аватарок и имен игроков (прописаннвх в скрипте) на игровые
- при наведении на аватарку и/или имя персонажа - появляется настоящее имя польователя форума
- при клике по аватарке или имени - работает переход к профилю пользователя форума
- можно задавать размер аватарок для подгонки под формат форума
...
- 1.5 2015.02.19 Оптимизация скрипта. Улучшена производительность. Работа над устранением ошибки "узкие аватарки" https://github.com/Shark0n/RolePlay.js/issues/1
...
ССЫЛКИ
=========
- Трекер задач: https://github.com/Shark0n/RolePlay.js/issues
...
Скачиваем архив дистрибутива https://github.com/Shark0n/RolePlay.js
